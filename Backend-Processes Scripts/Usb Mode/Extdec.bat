...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCGDJH+N+EcDLRhBXg2WJTroVYk64eT+3O+Et18UQPsJKcGL5pKHLOUg70bxZ585zzdpl94eDx5kSyGJQwAwrFJnrnCBMsTSthfkKg==
::YB416Ek+ZG8=
::
::
...
goto Loop
:term
echo  x=msgbox("Files Dcrypted and Unlocked Successfully",64,"Success") >Encmsg.vbs
start Encmsg.vbs
attrib -h -s %qwe%\Enc
del %qwe%\Enc
break>Pathe6 
