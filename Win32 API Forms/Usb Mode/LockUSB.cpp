    ...
    if (strcmp(password , cpassword) == 0)        
				{
                 ...
                 system("echo  USB Files Locked at %date% with %time% >>FilesActive");			 
				 system("echo. >>FilesActive");
				 //MessageBox(hwnd, "Your Files is Locked Successfully", "Yo!", MB_OK);
